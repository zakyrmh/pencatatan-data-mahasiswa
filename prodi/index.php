...
<head>
    ...
    <title>Pencatatan Data Program Studi</title>
                                ...
                                <?php foreach ($prodi as $prd): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="hapus.php?id=<?= $prd['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
